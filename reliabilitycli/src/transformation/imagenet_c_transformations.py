...
from ..constants import FROST_IMAGES_PATH
...
def frost(x, i):
    ...
    frost = Image.open(str(FROST_IMAGES_PATH / filename))
...
# ! TODO: there are variables undefined
...
#     color_jitter = A.ReplayCompose(
#         [ColorJitter(brightness=(0.5, 1), contrast=(0.5, 1), saturation=(0.5, 1), hue=(0.5, 1), always_apply=True)])
#     transformed_img = color_jitter(image=x)
#     # to get the parameters that are actually used
#     arguments = str(transformed_img['replay']['transforms'][0]['params']['contrast']) + ", " + str(
#         transformed_img['replay']['transforms'][0]['params']['saturation']) + ", " + str(
#         transformed_img['replay']['transforms'][0]['params']['hue'])
...
# def RGB(x, i):
#     RGB_Shift = A.ReplayCompose(
#         [RGBShift(r_shift_limit=[150, 400], g_shift_limit=[150, 400], b_shift_limit=[150, 400], always_apply=True)])
#     transformed_img = RGB_Shift(image=x)
#     # to get the parameters that are actually used
#     arguments = str(transformed_img['replay']['transforms'][0]['params']['r_shift']) + ", " + str(
#         transformed_img['replay']['transforms'][0]['params']['g_shift']) + ", " + str(
#         transformed_img['replay']['transforms'][0]['params']['b_shift'])
